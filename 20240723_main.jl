...
mutable struct Mutable_Variables
    ...
    policy_x::Array{Float64,7}
    policy_l::Array{Float64,7}
    policy_K::Array{Float64,7}
end
...
function variables_function(parameters::NamedTuple)
    ...
    V = zeros(a_size, n_size, ϵ_size, ν_size, inf_size, d_size, age_size)
    policy_a_p = ones(a_size, n_size, ϵ_size, ν_size, inf_size, d_size, age_size)
    policy_x = ones(a_size, n_size, ϵ_size, ν_size, inf_size, d_size, age_size)
    policy_l = ones(a_size, n_size, ϵ_size, ν_size, inf_size, d_size, age_size)
    policy_K = ones(a_size, n_size, ϵ_size, ν_size, inf_size, d_size, age_size)
